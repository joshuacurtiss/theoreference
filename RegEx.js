...
module.exports={
    ...
    CUESWITHNUMBERS_REGEX: /(?:art caption|art \d caption|presentation intro|article|service meeting|subheading|verse|summary|art|box \d+ p|box|par|question|review|presentation|p|q|r)/i,
    CUENUMBER_REGEX: /(?:\d{1,2}[a-f]?)/i,
    PARBOUNDARY_REGEX: /^(subheading|box|art|par|review|presentation|#\d|p\s|q\s|r\s)/i,
