...
module.exports={
    ...
    CUESWITHNUMBERS_REGEX: /(?:art\s*\d?\s*(?:caption|start|end)|presentation intro|article|service meeting|subheading|verse|summary|art|box \d+ p|box p|box|par|question|review|presentation|p|q|r)/i,
